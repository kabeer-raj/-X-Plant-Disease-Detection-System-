...
def model_prediction(test_image):
    ...
    try:
        model = tf.keras.models.load_model("D:\\Plant_Disease_Dataset\\trained_model.keras")
    ...
    input_arr = np.expand_dims(input_arr, axis=0)  # Convert image to a batch of 1
...
if app_mode == "Home":
    ...
    image_path = "D:\\Plant_Disease_Dataset\\home_page.jpeg"
...
# Prediction Page
    ...
    if test_image is not None:
        ...
        if st.button("Predict"):
            ...
            # Get the result index from the model prediction
            ...
            if result_index is not None:
                ...
                st.success(f"Model is Predicting: Its a **{class_name[result_index]}**")
